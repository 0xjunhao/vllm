...
if TYPE_CHECKING:
    ...
    VLLM_TOKEN_PADDING_FACTOR: int = 1
    ...
    VLLM_ENABLE_TOOL_NAME_VALIDATION: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_ENABLE_TOOL_NAME_VALIDATION": lambda: bool(
        int(os.getenv("VLLM_ENABLE_TOOL_NAME_VALIDATION", "0"))
    ),
